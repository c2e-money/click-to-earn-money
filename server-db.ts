...
function generateSeedData(): DbSchema {
  ...
  const seedUsers: (User & { passwordHash: string })[] = [
    ...
    },
    {
      ...
      totalClicks: 18700,
      balance: 34.25,
      availableBalance: 34.25,
      totalWithdrawn: 49.90,
...
export function getSystemConfig(): SystemConfig {
  ...
  if (!db.config) {
    db.config = { 
      globalCpm: 5.00,
      popunderCode: "https://rightyrely.com/bb/b4/56/bbb456b28eb721b73dd6d674de75b70b.js",
      bannerAdCode: '<script type="text/javascript">atOptions = { "key": "8c74b8ca965ea735ea244832d53e6222", "format": "iframe", "height": 250, "width": 300, "params": {} };</script><script type="text/javascript" src="//www.highperformanceformat.com/8c74b8ca965ea735ea244832d53e6222/invoke.js"></script>',
      nativeAdCode: '<script async="async" data-cfasync="false" src="//www.highperformanceformat.com/32f9b2e2cd7f03ce9395d5574f524b41/invoke.js"></script><div id="container-32f9b2e2cd7f03ce9395d5574f524b41"></div>',
      socialBarCode: '<script type="text/javascript" src="//www.highperformanceformat.com/c2/c5/97/c2c597f27cfa695a58c3a2e12cbf6a0f.js"></script>'
    };
    writeDb(db);
  } else {
    let updated = false;
    // Migrate from old placeholders if found
    if (db.config.popunderCode === undefined || db.config.popunderCode.includes("profitablecpmrate")) {
      db.config.popunderCode = "https://rightyrely.com/bb/b4/56/bbb456b28eb721b73dd6d674de75b70b.js";
      updated = true;
    }
    if (db.config.bannerAdCode === undefined || db.config.bannerAdCode.includes("a-ads.com")) {
      db.config.bannerAdCode = '<script type="text/javascript">atOptions = { "key": "8c74b8ca965ea735ea244832d53e6222", "format": "iframe", "height": 250, "width": 300, "params": {} };</script><script type="text/javascript" src="//www.highperformanceformat.com/8c74b8ca965ea735ea244832d53e6222/invoke.js"></script>';
      updated = true;
    }
    if (db.config.nativeAdCode === undefined || db.config.nativeAdCode.includes("a-ads.com")) {
      db.config.nativeAdCode = '<script async="async" data-cfasync="false" src="//www.highperformanceformat.com/32f9b2e2cd7f03ce9395d5574f524b41/invoke.js"></script><div id="container-32f9b2e2cd7f03ce9395d5574f524b41"></div>';
      updated = true;
    }
    if (db.config.socialBarCode === undefined || db.config.socialBarCode === "") {
      db.config.socialBarCode = '<script type="text/javascript" src="//www.highperformanceformat.com/c2/c5/97/c2c597f27cfa695a58c3a2e12cbf6a0f.js"></script>';
      updated = true;
    }
    if (updated) {
      writeDb(db);
...
export function updateSystemConfig(configUpdates: Partial<SystemConfig>): SystemConfig {
  const db = readDb();
  if (!db.config) {
