...
export default function StepPage() {
  ...
  return (
    <div className="min-h-screen bg-[#f1f1f1] text-gray-800 font-sans relative pb-12">
          ...
          <div className="bg-white border border-gray-200 rounded-2xl p-6 shadow-md w-full">
            ...
            <div className="flex justify-between mt-8 text-center divide-x divide-gray-200">
              <div className="flex-1 px-1">
                ...
                <p className="text-[9px] text-gray-500 mt-0.5">Your safety is our priority</p>
              </div>
              <div className="flex-1 px-1">
                <span className="text-blue-500 text-xl block mb-1">⚡</span>
                <p className="text-[11px] text-gray-800 font-bold">Super Fast</p>
                <p className="text-[9px] text-gray-500 mt-0.5">Get your link in seconds</p>
              </div>
              <div className="flex-1 px-1">
                <span className="text-emerald-500 text-xl block mb-1">💵</span>
                <p className="text-[11px] text-gray-800 font-bold">Earn Money</p>
                <p className="text-[9px] text-gray-500 mt-0.5">Earn more with every click</p>
              </div>
            </div>
            
            <div className="text-center mt-6 pt-4 border-t border-gray-100 text-[10px] text-gray-500 font-semibold">
              🛡️ Secured by Click To Earn Enterprise
            </div>
          </div>
        ) : (
