...
export default function Dashboard() {
  ...
  const handleGenerate = async () => {
    ...
    try {
        ...
        alert("Link Generated: " + shortAlias);
        setUrl(""); setAlias("");
    ...
    <div className="flex flex-col h-screen bg-[#0b0e14] text-white">
      ...
      <main className="flex-1 overflow-y-auto p-4 space-y-4 pb-24">
        ...
        <div className="bg-[#131722] p-4 rounded-2xl border border-[#1f2937]">
          ...
          <input type="text" value={alias} onChange={(e) => setAlias(e.target.value)} placeholder="Alias (Optional)" className="w-full bg-[#0b0e14] p-3 rounded-xl border border-[#1f2937] mb-3 text-sm outline-none" />
